 ...
 */
export declare type ParsedExpr = Message<"google.api.expr.v1alpha1.ParsedExpr"> & {
  /**
 ...
 */
export declare type SourceInfo = Message<"google.api.expr.v1alpha1.SourceInfo"> & {
  /**
 ...
 */
export declare type SourceInfo_Extension = Message<"google.api.expr.v1alpha1.SourceInfo.Extension"> & {
  /**
 ...
 */
export declare type SourceInfo_Extension_Version = Message<"google.api.expr.v1alpha1.SourceInfo.Extension.Version"> & {
  /**
 ...
 */
export declare type SourcePosition = Message<"google.api.expr.v1alpha1.SourcePosition"> & {
  /**
