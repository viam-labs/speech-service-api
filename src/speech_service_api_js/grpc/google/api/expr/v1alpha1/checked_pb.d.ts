 ...
 */
export declare type CheckedExpr = Message<"google.api.expr.v1alpha1.CheckedExpr"> & {
  /**
 ...
 */
export declare type Type = Message<"google.api.expr.v1alpha1.Type"> & {
  /**
   * The kind of type.
   *
 ...
 */
export declare type Type_ListType = Message<"google.api.expr.v1alpha1.Type.ListType"> & {
  /**
   * The element type.
   *
 ...
 */
export declare type Type_MapType = Message<"google.api.expr.v1alpha1.Type.MapType"> & {
  /**
   * The type of the key.
   *
 ...
 */
export declare type Type_FunctionType = Message<"google.api.expr.v1alpha1.Type.FunctionType"> & {
  /**
 ...
 */
export declare type Type_AbstractType = Message<"google.api.expr.v1alpha1.Type.AbstractType"> & {
  /**
 ...
 */
export declare type Decl = Message<"google.api.expr.v1alpha1.Decl"> & {
  /**
 ...
 */
export declare type Decl_IdentDecl = Message<"google.api.expr.v1alpha1.Decl.IdentDecl"> & {
  /**
 ...
 */
export declare type Decl_FunctionDecl = Message<"google.api.expr.v1alpha1.Decl.FunctionDecl"> & {
  /**
 ...
 */
export declare type Decl_FunctionDecl_Overload = Message<"google.api.expr.v1alpha1.Decl.FunctionDecl.Overload"> & {
  /**
 ...
 */
export declare type Reference = Message<"google.api.expr.v1alpha1.Reference"> & {
  /**
   * The fully qualified name of the declaration.
   *
   * @generated from field: string name = 1;
