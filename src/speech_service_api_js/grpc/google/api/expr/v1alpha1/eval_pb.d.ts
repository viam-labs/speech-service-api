 ...
 */
export declare const file_google_api_expr_v1alpha1_eval: GenFile;
 ...
 */
export declare type EvalState = Message<"google.api.expr.v1alpha1.EvalState"> & {
  /**
 ...
 */
export declare type EvalState_Result = Message<"google.api.expr.v1alpha1.EvalState.Result"> & {
  /**
 ...
 */
export declare type ExprValue = Message<"google.api.expr.v1alpha1.ExprValue"> & {
  /**
 ...
 */
export declare type ErrorSet = Message<"google.api.expr.v1alpha1.ErrorSet"> & {
  /**
 ...
 */
export declare type UnknownSet = Message<"google.api.expr.v1alpha1.UnknownSet"> & {
  /**
