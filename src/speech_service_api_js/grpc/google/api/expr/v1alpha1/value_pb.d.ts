 ...
 */
export declare const file_google_api_expr_v1alpha1_value: GenFile;
 ...
 */
export declare type Value = Message<"google.api.expr.v1alpha1.Value"> & {
  /**
 ...
 */
export declare type EnumValue = Message<"google.api.expr.v1alpha1.EnumValue"> & {
  /**
 ...
 */
export declare type ListValue = Message<"google.api.expr.v1alpha1.ListValue"> & {
  /**
 ...
 */
export declare type MapValue = Message<"google.api.expr.v1alpha1.MapValue"> & {
  /**
 ...
 */
export declare type MapValue_Entry = Message<"google.api.expr.v1alpha1.MapValue.Entry"> & {
  /**
   * The key.
   *
