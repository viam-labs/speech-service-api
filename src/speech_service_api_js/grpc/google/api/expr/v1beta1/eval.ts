...
export namespace google.api.expr.v1beta1 {
    ...
    export namespace EvalState {
        export class Result extends pb_1.Message {
            ...
            get expr() {
                return pb_1.Message.getWrapperField(this, IdRef, 1) as IdRef;
            }
            set expr(value: IdRef) {
            ...
            static fromObject(data: {
                expr?: ReturnType<typeof IdRef.prototype.toObject>;
                value?: number;
            }): Result {
                const message = new Result({});
                if (data.expr != null) {
                    message.expr = IdRef.fromObject(data.expr);
                }
                if (data.value != null) {
            ...
            serialize(w?: pb_1.BinaryWriter): Uint8Array | void {
                const writer = w || new pb_1.BinaryWriter();
                if (this.has_expr)
                    writer.writeMessage(1, this.expr, () => this.expr.serialize(writer));
                if (this.value != 0)
            ...
            static deserialize(bytes: Uint8Array | pb_1.BinaryReader): Result {
                ...
                while (reader.nextField()) {
                    ...
                    switch (reader.getFieldNumber()) {
                        case 1:
                            reader.readMessage(message.expr, () => message.expr = IdRef.deserialize(reader));
                            break;
                        case 2:
    ...
    export class ExprValue extends pb_1.Message {
        ...
        constructor(data?: any[] | ({} & (({
            value?: dependency_1.google.api.expr.v1beta1.Value;
            error?: never;
            unknown?: never;
        } | {
            value?: never;
        ...
        get value() {
            return pb_1.Message.getWrapperField(this, dependency_1.google.api.expr.v1beta1.Value, 1) as dependency_1.google.api.expr.v1beta1.Value;
        }
        set value(value: dependency_1.google.api.expr.v1beta1.Value) {
        ...
        static fromObject(data: {
            value?: ReturnType<typeof dependency_1.google.api.expr.v1beta1.Value.prototype.toObject>;
            ...
            if (data.value != null) {
                message.value = dependency_1.google.api.expr.v1beta1.Value.fromObject(data.value);
            }
            if (data.error != null) {
        ...
        static deserialize(bytes: Uint8Array | pb_1.BinaryReader): ExprValue {
            ...
            while (reader.nextField()) {
                ...
                switch (reader.getFieldNumber()) {
                    case 1:
                        reader.readMessage(message.value, () => message.value = dependency_1.google.api.expr.v1beta1.Value.deserialize(reader));
                        break;
                    case 2:
    ...
    export class UnknownSet extends pb_1.Message {
        ...
        get exprs() {
            return pb_1.Message.getRepeatedWrapperField(this, IdRef, 1) as IdRef[];
        }
        set exprs(value: IdRef[]) {
            pb_1.Message.setRepeatedWrapperField(this, 1, value);
        }
        static fromObject(data: {
            exprs?: ReturnType<typeof IdRef.prototype.toObject>[];
        }): UnknownSet {
            const message = new UnknownSet({});
            if (data.exprs != null) {
                message.exprs = data.exprs.map(item => IdRef.fromObject(item));
            }
            return message;
        }
        toObject() {
            ...
            if (this.exprs != null) {
                data.exprs = this.exprs.map((item: IdRef) => item.toObject());
            }
            return data;
        }
        serialize(): Uint8Array;
        ...
        serialize(w?: pb_1.BinaryWriter): Uint8Array | void {
            ...
            if (this.exprs.length)
                writer.writeRepeatedMessage(1, this.exprs, (item: IdRef) => item.serialize(writer));
            if (!w)
                return writer.getResultBuffer();
        }
        static deserialize(bytes: Uint8Array | pb_1.BinaryReader): UnknownSet {
            ...
            while (reader.nextField()) {
                ...
                switch (reader.getFieldNumber()) {
                    case 1:
                        reader.readMessage(message.exprs, () => pb_1.Message.addToRepeatedWrapperField(message, 1, IdRef.deserialize(reader), IdRef));
                        break;
                    default: reader.skipField();
                }
            }
    ...
    export class IdRef extends pb_1.Message {
        #one_of_decls: number[][] = [];
        constructor(data?: any[] | {
            id?: number;
        }) {
        ...
        static deserialize(bytes: Uint8Array | pb_1.BinaryReader): IdRef {
            const reader = bytes instanceof pb_1.BinaryReader ? bytes : new pb_1.BinaryReader(bytes), message = new IdRef();
            while (reader.nextField()) {
                if (reader.isEndGroup())
                    break;
                switch (reader.getFieldNumber()) {
        ...
        static deserializeBinary(bytes: Uint8Array): IdRef {
            return IdRef.deserialize(bytes);
        }
    }
}
