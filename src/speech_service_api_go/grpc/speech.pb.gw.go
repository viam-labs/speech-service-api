...
var (
	filter_SpeechService_ListenInBackground_0 = &utilities.DoubleArray{Encoding: map[string]int{"name": 0}, Base: []int{1, 1, 0}, Check: []int{0, 1, 2}}
)

func request_SpeechService_ListenInBackground_0(ctx context.Context, marshaler runtime.Marshaler, client SpeechServiceClient, req *http.Request, pathParams map[string]string) (SpeechService_ListenInBackgroundClient, runtime.ServerMetadata, error) {
	var protoReq ListenInBackgroundRequest
	var metadata runtime.ServerMetadata
	...
	if err := runtime.PopulateQueryParameters(&protoReq, req.Form, filter_SpeechService_ListenInBackground_0); err != nil {
		return nil, metadata, status.Errorf(codes.InvalidArgument, "%v", err)
	}

	stream, err := client.ListenInBackground(ctx, &protoReq)
	if err != nil {
...
func RegisterSpeechServiceHandlerServer(ctx context.Context, mux *runtime.ServeMux, server SpeechServiceServer) error {
	...
	mux.Handle("POST", pattern_SpeechService_Listen_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		ctx, cancel := context.WithCancel(req.Context())
		defer cancel()
		var stream runtime.ServerTransportStream
		ctx = grpc.NewContextWithServerTransportStream(ctx, &stream)
	...
	mux.Handle("GET", pattern_SpeechService_ListenInBackground_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
...
func RegisterSpeechServiceHandlerClient(ctx context.Context, mux *runtime.ServeMux, client SpeechServiceClient) error {
	...
	mux.Handle("GET", pattern_SpeechService_ListenInBackground_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateContext(ctx, mux, req, "/viamlabs.service.speech.v1.SpeechService/ListenInBackground", runtime.WithHTTPPathPattern("/viamlabs/api/v1/service/speech/{name}/listen_in_background"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
		resp, md, err := request_SpeechService_ListenInBackground_0(annotatedContext, inboundMarshaler, client, req, pathParams)
		annotatedContext = runtime.NewServerMetadataContext(annotatedContext, md)
		if err != nil {
			runtime.HTTPError(annotatedContext, mux, outboundMarshaler, w, req, err)
			return
		...
		forward_SpeechService_ListenInBackground_0(annotatedContext, mux, outboundMarshaler, w, req, func() (proto.Message, error) { return resp.Recv() }, mux.GetForwardResponseOptions()...)
...
var (
	...
	pattern_SpeechService_ListenInBackground_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3, 2, 4, 1, 0, 4, 1, 5, 5, 2, 6}, []string{"viamlabs", "api", "v1", "service", "speech", "name", "listen_in_background"}, ""))
...
var (
	...
	forward_SpeechService_ListenInBackground_0 = runtime.ForwardResponseStream
